...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opl-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12462&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opl-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opl` can be installed with `conda`:
...
It is possible to list all of the versions of `opl` available on your platform with `conda`:
...
```
mamba search opl --channel conda-forge
```
...
mamba repoquery search opl --channel conda-forge

# List packages depending on `opl`:
mamba repoquery whoneeds opl --channel conda-forge

# List dependencies of `opl`:
mamba repoquery depends opl --channel conda-forge
```
